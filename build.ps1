...
try {
    ...
    # acs round.ico so the .exe's file icon and the tray icon both use it (resource ID 1,
    ...
    go run github.com/akavel/rsrc@latest -ico "..\..\Icon\acs round.ico" -o rsrc_windows_amd64.syso -arch amd64
