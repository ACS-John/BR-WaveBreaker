...
stripped of debug symbols, using the app's `Core\Icon\ACS-v5.ico` for both
...
`rsrc_windows_amd64.syso`, embedding `ACS-v5.ico` as Windows resource ID 1
...
- `rsrc_windows_amd64.syso` — generated by `build.ps1`; embeds `ACS-v5.ico` as resource ID 1.
